@echo off
rem Fichero por lotes del comprobador de la Pr4.
...
if "_Opc_"=="-g" goto grafico
if "%1"=="" goto error
cd %1\..
:grafico
echo Validando la entrega de la Pr4...
java -cp "%dirname%/prog/check.jar" es.fdi.gaia.validaPracticas.Valida Pr4 %1
pause
goto end
:error
