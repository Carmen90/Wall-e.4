...
public class CityLoaderFromTxtFile {
	...
	/**
	 * Método que dada una entrada te devuelve sus dos siguientes elementos
	 * @param entrada de la que se cogen los elementos
	 * @param resp elemento string que se coge de la entrada
	 * @return elemento entero que coge de la entrada
	 * @throws WrongCityFormatException
	 */
	public int aux ( Scanner entrada, String resp) 
			throws WrongCityFormatException{
		int num;
		num = controlNextInt ( entrada);
		resp = controlNext (entrada);
	 ...
	 * @param resp string que te dice si la calle esta abierta o no
	 ...
	 * @throws WrongCityFormatException
	 */
	public void isOpen ( String resp, int num, int numPlaceIni, Direction direccion, int numPlaceFin, Scanner entrada)
			throws WrongCityFormatException{
